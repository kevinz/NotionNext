...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://devops.gold', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'devops,kubernetes,platform engineering,aiops,finops', // 网站关键词 英文逗号隔开
